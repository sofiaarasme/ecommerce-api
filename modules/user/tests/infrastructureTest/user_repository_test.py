...
from modules.user.infrastructure.user_repository import UserRepositoryImplementation  # Importa la implementación correcta
...
def test_register_user(user_repository, session):
    user_data = {"username": "testuser", "email": "test@example.com", "hashed_password": "password", "role": Role.CUSTOMER.value}
    user = User(**user_data)
